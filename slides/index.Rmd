...
Podemos mejorar la representación **estandarizando por rango** las variables, haciendo uso de `rescale()` del paquete `{scales}`
...
fviz_nbclust(iris_range %>%
                    select(-Species), kmeans, method = "wss") +
...
Dicha representación puede ser mejorada **estandarizando los datos por rango**
